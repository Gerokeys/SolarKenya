      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            ...
            {
              to: '/admin/users', label: 'Manage Users', sub: 'Add or remove admin accounts',
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-ember-500">
                  <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" /><circle cx="12" cy="7" r="4" /><line x1="19" y1="8" x2="19" y2="14" /><line x1="22" y1="11" x2="16" y2="11" />
                </svg>
              ),
            },
